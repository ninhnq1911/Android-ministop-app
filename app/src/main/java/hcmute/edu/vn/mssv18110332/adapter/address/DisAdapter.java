...
public class DisAdapter extends ArrayAdapter<Districts> {
    public DisAdapter(@NonNull Context context, int resource, @NonNull List<Districts> objects) {
        super(context, resource, objects);
    }

    public DisAdapter(@NonNull Context context, int resource) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Districts pro = this.getItem(position);
        if (pro!=null)
        {
